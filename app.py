...
header1 = '<h2 style="text-align: center;font-size:65px;color:#002b80"><b>Predisine - A Disease Predictor<b></h2>'
...
if option =='Normal Disease':
    ...
    subheader = '<h4 style="text-align:center;font-size:18px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus fermentum purus aliquam, auctor risus non, imperdiet sem. Sed diam ipsum, lobortis at sem id, suscipit consequat nibh. Vestibulum eros nisi, accumsan non arcu vulputate, lobortis ultricies sapien.</h4>'
    ...
    if fullName:
      ...
      if len(multi)!=7:
        st.write('Enter Only seven Symptoms to check what kind of disease do yo have!!!')
        st.write('Error will get removed once seven symptoms are entered')
